...
#RUN npm install -g /tmp/anypoint-cli-2.2.0.tgz
RUN curl https://support.mulesoft.com/servlet/servlet.FileDownload?file=01534000002PIyA > /tmp/anypoint-cli-2.2.0.tgz
RUN npm install -g /tmp/anypoint-cli-2.2.0.tgz
